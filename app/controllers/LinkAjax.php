...
class LinkAjax extends Controller {
    ...
    private function create_biolink() {
        ...
        Response::json(l('global.success_message.create2'), 'success', ['url' => url('link/' . $link_id . '?tab=links')]);
    }
    ...
    private function update_biolink() {
        ...
        $_POST['background_attachment'] = in_array($_POST['background_attachment'], ['scroll', 'fixed']) ? $_POST['background_attachment'] : 'scroll';
        ...
        $_POST['verified_location'] = in_array($_POST['verified_location'], ['top', 'bottom', 'title']) ? query_clean($_POST['verified_location']) : 'top';
        ...
        if($_POST['biolink_theme_id'] && $link->biolink_theme_id != $_POST['biolink_theme_id']) {
            ...
            $themable_blocks = ['link', 'email_collector', 'paypal', 'phone_collector', 'rss_feed', 'vcard', 'cta', 'youtube_feed', 'share', 'file', 'product', 'donation', 'service'];
