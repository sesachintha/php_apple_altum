...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                <label for="biolink_block_border_shadow_offset_x"><i class="fa fa-fw fa-arrows-alt-h fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_shadow_offset_x') ?></label>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                <label for="biolink_block_border_shadow_offset_y"><i class="fa fa-fw fa-arrows-alt-v fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_shadow_offset_y') ?></label>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                <label for="biolink_block_border_shadow_blur"><i class="fa fa-fw fa-arrows-alt fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_shadow_blur') ?></label>
            ...
            <div class="form-group" data-range-counter data-range-counter-suffix="px">
                <label for="biolink_block_border_shadow_spread"><i class="fa fa-fw fa-border-all fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_shadow_spread') ?></label>
            ...
            <div class="form-group">
                <label for="biolink_block_border_shadow_color"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_shadow_color') ?></label>
