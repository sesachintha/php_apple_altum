...
<div class="row">
    <div class="col-12 col-lg mb-3 mb-lg-0">
        <ul class="list-style-none d-flex flex-column flex-lg-row flex-wrap m-0">
           ...
           <li class="mb-2 mr-lg-3"><a href="<?= url('tools') ?>">Web Tools</a></li>

           <li class="mb-2 mr-lg-3"><a href="https://alltransfers.link/" target="_blank" >Alltransfers</a></li>
    ...
    <div class="col-12 col-lg-auto">
        <div class="d-flex flex-wrap mentions-perso">
            <span class="madeby">By <a target="_blank" href="https://kevinragonneau.fr/blog/">Kevin Ragonneau</a></span>
