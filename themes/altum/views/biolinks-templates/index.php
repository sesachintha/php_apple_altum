...
<div class="container">
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 page-templates">
            <h1 class="h4 m-0"><?= l('biolinks_templates.header') ?></h1>
            <h2 class="h6 m-0">Choisissez l'un de nos templates pour lancer votre page en quelques minutes. <br />Vous pourrez ensuite toujours la modifier à 100% 👌</h2>
        ...
        <div class="col-12 col-lg-auto d-flex filtres-themes">
            <div class="ml-3">
                <div class="dropdown">
    ...
    <div>
        <div class="row listing-themes">
            <?php foreach($data->biolinks_templates as $row): ?>
                <div class="col-lg-6 col-xl-4">
                    <div class="custom-row mb-4 d-flex flex-column justify-content-between">
                        <a type="button" class="no-style" data-toggle="modal" data-target="#create_biolink" onclick="document.querySelector(`input[name='biolink_template_id']`).value = <?= $row->biolink_template_id ?>;">
                            <div class="mb-3">
                        ...
                        <a href="<?= $row->url ?>" target="_blank" class="btn btn-block btn-sm btn-light preview-theme"><i class="fa fa-fw fa-sm fa-external-link-alt mr-1"></i> <?= l('biolinks_templates.preview') ?></a>
                    </div>
                </div>
            <?php endforeach ?>
        </div>
