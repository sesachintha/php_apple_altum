...
<head>
    ...
    <?php foreach(['custom.css'] as $file): ?>
        <link href="<?= ASSETS_FULL_URL . 'css/' . $file . '?v=05052023V2' . PRODUCT_CODE ?>" rel="stylesheet" media="screen,print">
    <?php endforeach ?>
 ...
 crossorigin="anonymous"></script>
    ...
    <!-- Chat -->
    <script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="f546c16d-7337-488d-8d5c-c0b2d187cfa9";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
    <!-- End chat -->
...
<?php foreach(['libraries/jquery.min.js', 'libraries/popper.min.js', 'libraries/bootstrap.min.js', 'custom.js', 'libraries/fontawesome-all.min.js'] as $file): ?>
    <script src="<?= ASSETS_FULL_URL ?>js/<?= $file ?>?v=1640203<?= PRODUCT_CODE ?>"></script>
<?php endforeach ?>
