...
<div class="container container-pages page-contact">
    ...
    <div class="d-flex align-items-center mb-4">
        <h1><?= l('contact.header') ?></h1>
    </div>

    <form class="form-contact" action="" method="post" role="form">
        ...
        <button type="submit" name="submit" class="submit-contact"><?= l('global.submit') ?></button>
    </form>
</div>
