    ...
    <div class="col-12 col-lg-auto d-flex">
        <div style="display: flex;flex-wrap: wrap;gap: 10px;">
            ...
            <button type="button" data-toggle="modal" data-target="#create_biolink" class="btn btn-primary">
             ...
             <a href="<?= url('biolinks-templates') ?>">
                <button type="button" class="btn btn-primary" style="background: #FFF;color: #2980b9;">
                   Templates <!-- <span style="font-style:italic">(bêta)</span> -->
                </button>
            </a>
            ...
            <div class="row">
                ...
                <div class="col-4 col-lg-4 col-xl-2 d-flex justify-content-center justify-content-lg-end align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="<?= url('link/' . $row->link_id . '?tab=links') ?>" class="dropdown-item"><i class="fa fa-fw fa-sm fa-pen mr-2"></i> <?= l('global.edit') ?></a>
                            ...
                            <?php endif ?>
                            <a href="#" data-toggle="modal" data-target="#link_duplicate_modal" class="dropdown-item" data-link-id="<?= $row->link_id ?>"><i class="fa fa-fw fa-sm fa-clone mr-2"></i> <?= l('global.duplicate') ?></a>
                            <a href="#" data-toggle="modal" data-target="#link_delete_modal" class="dropdown-item" data-link-id="<?= $row->link_id ?>"><i class="fa fa-fw fa-sm fa-trash mr-2"></i> <?= l('global.delete') ?></a>
                        </div>
                    </div>
                </div>
            </div>
