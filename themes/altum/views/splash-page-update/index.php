        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <?php if(!empty($data->splash_page->settings->logo)): ?>
                        <div class="row">
                            <div class="my-2 col-6 col-xl-4">
                                <img src="<?= \Altum\Uploads::get_full_url('splash_pages') . $data->splash_page->settings->logo ?>" class="img-fluid" loading="lazy" />
                            </div>
                        </div>
