...
<div class="container container-pages">
    ...
    <div class="row mt-4">
        <div class="col-12 col-lg-8 wrapper-articles-blog">
            <div class="container-articles-blog">
            <?php foreach($data->blog_posts as $blog_post): ?>
                <div class="card item-article-blog">
                    <div class="card-body">
                        ...
                        <a href="<?= SITE_URL . ($blog_post->language ? \Altum\Language::$active_languages[$blog_post->language] . '/' : null) . 'blog/' . $blog_post->url ?>" class="text-decoration-none link-blog-full">Lire en entier</a>
                    </div>
                </div>
            <?php endforeach ?>
            </div>
