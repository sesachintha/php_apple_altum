    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page">
                <?= sprintf(l('link.header.header'), $data->link->url) ?>
            </li>
        </ol>
    </nav>
    */ ?>
    ...
    <div class="row">
        ...
        <div class="col-auto">
            <div class="d-flex align-items-center">
                ...
                >
                    <i class="fa fa-fw fa-sm fa-clone"></i>
                </button>
                ...
                <?php if($data->method != 'settings'): ?>
                    <a href="<?= url('link/' . $data->link->link_id . '/settings') ?>" class="btn btn-link text-secondary" data-toggle="tooltip" title="<?= l('global.edit') ?>"><i class="fa fa-fw fa-pen"></i></a>
                <?php endif ?>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="<?= url('link/' . $data->link->link_id) ?>" class="dropdown-item"><i class="fa fa-fw fa-sm fa-pen mr-2"></i> <?= l('global.edit') ?></a>
                        ...
                        <?php endif ?>
                        <a href="#" data-toggle="modal" data-target="#link_duplicate_modal" class="dropdown-item" data-link-id="<?= $data->link->link_id ?>"><i class="fa fa-fw fa-sm fa-clone mr-2"></i> <?= l('global.duplicate') ?></a>
                        <a href="#" data-toggle="modal" data-target="#link_delete_modal" class="dropdown-item" data-link-id="<?= $data->link->link_id ?>"><i class="fa fa-fw fa-sm fa-trash mr-2"></i> <?= l('global.delete') ?></a>
                    </div>
                </div>
            </div>
        </div>
