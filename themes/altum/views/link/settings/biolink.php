...
<?php ob_start() ?>
<div class="row page-link-app">
    <div class="col-12 col-xl-6">

        <div class="d-flex justify-content-between block-mobile sticky-tab-app">
            <ul class="nav nav-pills mb-4 menu-app-tab" id="pills-tab" role="tablist">
                <li class="nav-item">
            ...
            <div>
                <button type="button" data-toggle="modal" data-target="#biolink_link_create_modal" class="btn btn-primary btn-add-block"><i class="fa fa-fw fa-plus-circle"></i> <?= l('links.create_biolink_block') ?></button>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('link.settings.url') ?></label>
                            ...
                            <div class="collapse" id="customizations_container">
                                ...
                                <div class="form-group mt-2">
                                    <label for="background_attachment"><i class="fa fa-fw fa-print fa-sm text-muted mr-1"></i> <?= l('link.settings.background_attachment') ?></label>
                            ...
                            */ ?>
                                        ...
                                        <div class="<?= $data->link->is_verified ? null : 'container-disabled' ?>">
                                            <div class="form-group">
                                                ...
                                                <select id="verified_location" name="verified_location" class="form-control">
                                                    ...
                                                    <option value="title" <?= $data->link->settings->verified_location == 'title' ? 'selected="selected"' : null?>>À côté du 1er bloc titre ou texte</option>
                            ...
                            <button class="btn btn-block btn-gray-200 my-4" type="button" data-toggle="collapse" data-target="#no-ads" aria-expanded="false" aria-controls="no_ads">
                                <i class="fa fa-fw fa-ban fa-sm mr-1"></i>Supprimer la pub
                            </button>
                            <?php else : ?>
                            <button class="btn btn-block btn-gray-200 my-4" type="button" data-toggle="collapse" data-target="#no-ads" aria-expanded="false" aria-controls="no_ads">
                                <i class="fa fa-fw fa-euro-sign fa-sm mr-1"></i>Abonnement "Pas de pub"
                            </button>
                            <?php endif ?>

                            <div class="collapse" id="no-ads">
                                <div class="alert alert-info">
                                    <?php if(!$this->user->plan_settings->no_ads):?>
                                    Vous pouvez supprimer la pub et la mention à Allinks en bas de votre page en <a target="_blank" href="https://www.patreon.com/Allinks/">souscrivant à l'un de nos abonnements</a> sans engagement.
                                    <?php else : ?>
                                    Vous pouvez <a target="_blank" href="https://www.patreon.com/Allinks/">suspendre votre abonnement</a> à tout moment et remettre la publicité / mention à Allinks en bas de votre page pour continuer à profiter du service gratuitement.
                                    <?php endif ?>
                                </div>
                            </div>

                            <?php if($this->user->plan_settings->removable_branding):?>
                            ...
                            <div class="text-center mt-4 btn-update-page-edit">
    ...
    <div class="col-12 col-xl-6 mt-5 mt-xl-0 justify-content-center justify-content-xl-end preview-page-edit">
    ...
    <div>
        <button type="button" class="btn btn-preview-open"><i class="fa fa-fw fa-eye"></i> Preview</button>
        <button type="button" class="btn btn-preview-open open"><i class="fa fa-fw fa-times"></i> Retour</button>
    </div>
...
<script>
    (function($) {
        /* Preview mobile */
        $('.btn-preview-open').click(function() {
            $('.page-link-app').toggleClass('preview-open');
        });
    })(jQuery);
</script>
