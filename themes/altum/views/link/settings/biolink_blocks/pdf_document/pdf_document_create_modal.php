            ...
            <div class="modal-body">
                <form name="create_biolink_pdf_document" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="pdf_document_file"><i class="fa fa-fw fa-file fa-sm text-muted mr-1"></i> <?= l('create_biolink_pdf_document_modal.file') ?></label>
                    ...
                    <div class="form-group">
                        <label for="pdf_document_name"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.name') ?></label>
