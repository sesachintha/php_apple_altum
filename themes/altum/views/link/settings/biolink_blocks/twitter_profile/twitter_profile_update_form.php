...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'twitter_profile_location_url_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_twitter_profile_modal.location_url') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'twitter_profile_theme_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-sun fa-sm text-muted mr-1"></i> <?= l('create_biolink_twitter_profile_modal.theme') ?></label>
