            ...
            <div class="modal-body">
                <form name="create_biolink_telegram" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="telegram_location_url" type="text" class="form-control" name="location_url" placeholder="<?= l('create_biolink_telegram_modal.location_url_placeholder') ?>" required="required" />
                    </div>
