...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'block_border_radius_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-all fa-sm text-muted mr-1"></i> Style de la photo</label>
    ...
    <div class="form-group">
        <label for="<?= 'block_object_fit_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-print fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.object_fit') ?></label>
        <div class="row btn-group-toggle" data-toggle="buttons">
