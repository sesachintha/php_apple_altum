...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="mb-3">
        <button data-add="timeline_item" data-biolink-block-id="<?= $row->biolink_block_id ?>" type="button" class="btn btn-sm btn-add-element-block btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Ajouter un élément</button>
    </div>
