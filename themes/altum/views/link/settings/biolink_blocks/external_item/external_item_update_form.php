...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'external_item_name_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.name_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'external_item_description_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.description_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'external_item_price_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_external_item_modal.price_color') ?></label>
