...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'markdown_text_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.text') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'markdown_background_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.background_color') ?></label>
