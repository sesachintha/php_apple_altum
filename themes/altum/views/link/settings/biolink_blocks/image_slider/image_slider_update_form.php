...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="collapse" id="<?= 'slider_items_container_' . $row->biolink_block_id ?>">
        ...
        <div class="mb-3">
            <button data-add="image_slider_item" data-biolink-block-id="<?= $row->biolink_block_id ?>" type="button" class="btn btn-sm btn-add-element-block btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Ajouter un élément</button>
        </div>
    </div>
