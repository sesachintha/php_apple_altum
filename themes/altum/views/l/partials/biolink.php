...
<div class="container animate__animated animate__fadeIn">
    <div class="row d-flex justify-content-center text-center">
        <div class="col-md-8 link-content <?= isset($_GET['preview']) ? 'container-disabled-simple' : null ?>">
            ...
            <main id="links" class="my-3 <?php if($data->link->is_verified): ?>page-certifie<?php endif ?>">
                <div class="row">
            ...
            <footer id="footer" class="link-footer">
                ...
                <?php if($data->link->settings->display_branding): ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php else : ?>
                             Page créée avec <a target="_blank" href="https://allinks.click/">Allinks</a> ✨                         
                        <?php endif ?>
                    <?php endif ?>
                <?php endif ?>
                </div>
...
<script>
    ...
    if($('.page-certifie').length){
        $('.bloc-certification').eq(0).addClass("blue-badge");
    }
</script>
